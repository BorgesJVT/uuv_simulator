...
{
  uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request * msg = (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request *)malloc(sizeof(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request));
  if (!msg) {
    return NULL;
  }
...
uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__Sequence__init(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request *)calloc(size, sizeof(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request));
    if (!data) {
      return false;
    }
...
{
  uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__Sequence * array = (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__Sequence *)malloc(sizeof(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response * msg = (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response *)malloc(sizeof(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response));
  if (!msg) {
    return NULL;
  }
...
uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__Sequence__init(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response *)calloc(size, sizeof(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__Sequence * array = (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__Sequence *)malloc(sizeof(uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__Sequence));
  if (!array) {
    return NULL;
  }
