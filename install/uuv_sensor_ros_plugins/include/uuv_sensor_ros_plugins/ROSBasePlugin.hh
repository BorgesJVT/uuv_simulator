...
#include "uuv_sensor_ros_plugins_msgs/srv/change_sensor_state.h"
...
namespace gazebo
{
  class ROSBasePlugin
  {
    ...
    gazebo_ros::Node::SharedPtr ros_node_{nullptr}; // rosNode

    /// Gazebo's node handle for transporting measurement  messages.
    gazebo::transport::NodePtr gazebo_node_;  // gazeboNode
