...
class PositionControllerNode:
    def __init__(self):
        ...
        # ROS infrastructure
        self.sub_cmd_pose = self.create_subscription('cmd_pose', geometry_msgs.PoseStamped, self.cmd_pose_callback)
        self.sub_odometry = self.create_subscription('odom', Odometry, self.odometry_callback)
        self.pub_cmd_vel = self.create_publisher('cmd_vel', geometry_msgs.Twist, 10)
