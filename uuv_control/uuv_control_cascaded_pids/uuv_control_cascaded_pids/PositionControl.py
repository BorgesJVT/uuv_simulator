...
import numpy
import rclpy
import tf2_py.transformations as trans
from PID import PIDRegulator

#from dynamic_reconfigure.server import Server
from uuv_control_cascaded_pid.cfg import PositionControlConfig
#import geometry_msgs.msg as geometry_msgs
from geometry_msgs.msg import geometry_msgs, Twist
from nav_msgs.msg import Odometry

class PositionControllerNode(Node):
    def __init__(self):
        super(PositionControllerNode, self).__init__()
        ...
        # ROS infrastructure
        self.sub_cmd_pose = self.create_subscription(PoseStamped, 'cmd_pose', self.cmd_pose_callback, 2)
        self.sub_odometry = self.create_subscription(Odometry, 'odom', self.odometry_callback, 1)
...
def main(args=None):
    ...
    self.init_node('position_control')
