...
{
  uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request * msg = (uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request *)malloc(sizeof(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request));
  if (!msg) {
    return NULL;
  }
...
uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request__Sequence__init(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request *)calloc(size, sizeof(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request));
    if (!data) {
      return false;
    }
...
{
  uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request__Sequence * array = (uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request__Sequence *)malloc(sizeof(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response * msg = (uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response *)malloc(sizeof(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response));
  if (!msg) {
    return NULL;
  }
...
uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response__Sequence__init(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response *)calloc(size, sizeof(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response__Sequence * array = (uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response__Sequence *)malloc(sizeof(uuv_gazebo_ros_plugins_msgs__srv__GetThrusterState_Response__Sequence));
  if (!array) {
    return NULL;
  }
