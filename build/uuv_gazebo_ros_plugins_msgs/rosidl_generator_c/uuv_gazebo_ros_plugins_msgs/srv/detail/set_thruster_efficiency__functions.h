...
#ifndef UUV_GAZEBO_ROS_PLUGINS_MSGS__SRV__DETAIL__SET_THRUSTER_EFFICIENCY__FUNCTIONS_H_
#define UUV_GAZEBO_ROS_PLUGINS_MSGS__SRV__DETAIL__SET_THRUSTER_EFFICIENCY__FUNCTIONS_H_
...
/// Initialize srv/SetThrusterEfficiency message.
/**
...
/// Finalize srv/SetThrusterEfficiency message.
/**
...
/// Create srv/SetThrusterEfficiency message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Request__init().
...
/// Destroy srv/SetThrusterEfficiency message.
/**
 * It calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Request__fini()
...
/// Initialize array of srv/SetThrusterEfficiency messages.
/**
...
/// Finalize array of srv/SetThrusterEfficiency messages.
/**
 * It calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Request__fini()
...
/// Create array of srv/SetThrusterEfficiency messages.
/**
 * It allocates the memory for the array and calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetThrusterEfficiency messages.
/**
 * It calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_gazebo_ros_plugins_msgs
...
/**
 * It calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_gazebo_ros_plugins_msgs
...
/**
 * It allocates the memory for the array and calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_gazebo_ros_plugins_msgs
...
/**
 * It calls
 * uuv_gazebo_ros_plugins_msgs__srv__SetThrusterEfficiency_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UUV_GAZEBO_ROS_PLUGINS_MSGS__SRV__DETAIL__SET_THRUSTER_EFFICIENCY__FUNCTIONS_H_
