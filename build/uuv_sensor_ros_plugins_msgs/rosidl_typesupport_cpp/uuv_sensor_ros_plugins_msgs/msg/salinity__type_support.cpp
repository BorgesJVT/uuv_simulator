...
static const _Salinity_type_support_symbol_names_t _Salinity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_sensor_ros_plugins_msgs, msg, Salinity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uuv_sensor_ros_plugins_msgs, msg, Salinity)),
  }
};
...
{
  return &::uuv_sensor_ros_plugins_msgs::msg::rosidl_typesupport_cpp::Salinity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uuv_sensor_ros_plugins_msgs, msg, Salinity)() {
  return get_message_type_support_handle<uuv_sensor_ros_plugins_msgs::msg::Salinity>();
}
