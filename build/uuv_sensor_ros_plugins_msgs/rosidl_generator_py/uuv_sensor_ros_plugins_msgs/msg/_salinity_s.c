...
bool uuv_sensor_ros_plugins_msgs__msg__salinity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_sensor_ros_plugins_msgs.msg._salinity.Salinity", full_classname_dest, 50) == 0);
  }
  uuv_sensor_ros_plugins_msgs__msg__Salinity * ros_message = _ros_message;
  {  // header
  ...
  {  // salinity
    ...
    ros_message->salinity = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // variance
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * uuv_sensor_ros_plugins_msgs__msg__salinity__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Salinity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_sensor_ros_plugins_msgs.msg._salinity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Salinity");
  ...
  uuv_sensor_ros_plugins_msgs__msg__Salinity * ros_message = (uuv_sensor_ros_plugins_msgs__msg__Salinity *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
