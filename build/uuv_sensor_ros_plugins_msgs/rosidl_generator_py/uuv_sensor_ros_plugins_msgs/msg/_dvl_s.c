...
bool uuv_sensor_ros_plugins_msgs__msg__dvl_beam__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * uuv_sensor_ros_plugins_msgs__msg__dvl_beam__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool uuv_sensor_ros_plugins_msgs__msg__dvl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_sensor_ros_plugins_msgs.msg._dvl.DVL", full_classname_dest, 40) == 0);
  }
  uuv_sensor_ros_plugins_msgs__msg__DVL * ros_message = _ros_message;
  {  // header
  ...
  {  // beams
    ...
    if (!uuv_sensor_ros_plugins_msgs__msg__DVLBeam__Sequence__init(&(ros_message->beams), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create uuv_sensor_ros_plugins_msgs__msg__DVLBeam__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    uuv_sensor_ros_plugins_msgs__msg__DVLBeam * dest = ros_message->beams.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!uuv_sensor_ros_plugins_msgs__msg__dvl_beam__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * uuv_sensor_ros_plugins_msgs__msg__dvl__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of DVL */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_sensor_ros_plugins_msgs.msg._dvl");
  ...
  uuv_sensor_ros_plugins_msgs__msg__DVL * ros_message = (uuv_sensor_ros_plugins_msgs__msg__DVL *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // beams
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = uuv_sensor_ros_plugins_msgs__msg__dvl_beam__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
