...
#ifndef UUV_WORLD_ROS_PLUGINS_MSGS__SRV__DETAIL__SET_CURRENT_VELOCITY__FUNCTIONS_H_
#define UUV_WORLD_ROS_PLUGINS_MSGS__SRV__DETAIL__SET_CURRENT_VELOCITY__FUNCTIONS_H_
...
/// Initialize srv/SetCurrentVelocity message.
/**
...
/// Finalize srv/SetCurrentVelocity message.
/**
...
/// Create srv/SetCurrentVelocity message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Request__init().
...
/// Destroy srv/SetCurrentVelocity message.
/**
 * It calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Request__fini()
...
/// Initialize array of srv/SetCurrentVelocity messages.
/**
...
/// Finalize array of srv/SetCurrentVelocity messages.
/**
 * It calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Request__fini()
...
/// Create array of srv/SetCurrentVelocity messages.
/**
 * It allocates the memory for the array and calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetCurrentVelocity messages.
/**
 * It calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_world_ros_plugins_msgs
...
/**
 * It calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_world_ros_plugins_msgs
...
/**
 * It allocates the memory for the array and calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_world_ros_plugins_msgs
...
/**
 * It calls
 * uuv_world_ros_plugins_msgs__srv__SetCurrentVelocity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UUV_WORLD_ROS_PLUGINS_MSGS__SRV__DETAIL__SET_CURRENT_VELOCITY__FUNCTIONS_H_
