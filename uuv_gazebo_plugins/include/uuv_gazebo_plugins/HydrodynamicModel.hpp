#ifndef UUV_GAZEBO_PLUGINS__HYDRO_MODEL_HPP__
#define UUV_GAZEBO_PLUGINS__HYDRO_MODEL_HPP__
...
#include <uuv_gazebo_plugins/BuoyantObject.hpp>
...
class HydrodynamicModel : public BuoyantObject
{
  ...
  protected: HydrodynamicModel(sdf::ElementPtr _sdf, gazebo::physics::LinkPtr _link);
...
class HMFossen : public HydrodynamicModel
{
  ...
  protected: HMFossen(sdf::ElementPtr _sdf, gazebo::physics::LinkPtr _link);
...
class HMSphere : public HMFossen
{
  ...
  protected: HMSphere(sdf::ElementPtr _sdf, gazebo::physics::LinkPtr _link);
...
class HMCylinder : public HMFossen
{
  ...
  protected: HMCylinder(sdf::ElementPtr _sdf, gazebo::physics::LinkPtr _link);
...
class HMSpheroid : public HMFossen
{
  ...
  protected: HMSpheroid(sdf::ElementPtr _sdf, gazebo::physics::LinkPtr _link);
...
class HMBox : public HMFossen
{
  ...
  /// \brief Constructor
  protected: HMBox(sdf::ElementPtr _sdf, gazebo::physics::LinkPtr _link);
...
#endif  // __UUV_GAZEBO_PLUGINS__HYDRO_MODEL_HPP__