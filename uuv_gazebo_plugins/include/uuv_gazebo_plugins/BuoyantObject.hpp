#ifndef __UUV_GAZEBO_PLUGINS__BUOYANT_OBJECT_HPP__
#define __UUV_GAZEBO_PLUGINS__BUOYANT_OBJECT_HPP__
...
{
  /// \brief Constructor
  public: BuoyantObject(gazebo::physics::LinkPtr _link);
  ...
  public: void SetBoundingBox(const ignition::math::Boxd &_bBox);
  ...
  protected: ignition::math::Boxd boundingBox;
